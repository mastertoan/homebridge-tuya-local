...
class TuyaAccessory extends EventEmitter {
    ...
    _connect() {
        ...
        this.log.info(`${this.context.name} - Connection details:
            IP: ${this.context.ip}
        ...
        this._socket.on('error', err => {
            this.connected = false;
            this.log.debug(`Socket error for ${this.context.name}: ${err.message}`);
        ...
        this._socket.on('close', err => {
            ...
            this.log.info(`${this.context.name} - Socket closed, reconnection status: ${this._socket.connecting}`);
        });
